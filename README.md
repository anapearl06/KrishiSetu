...
List Produce (Crop, Variety, Quantity, Quality)

Set Availability & Expected Price

View Market Insights & Buyer Opportunities

Receive & Review Buyer Offers (Accept / Reject)

Fulfill Order & Track Payment Status

Buyer Workflow
Register & Create Profile

Create Demand (Crop, Quantity, Quality, Budget, Location)

Submit Demand to Matching Engine

Review Ranked Recommendations with Explainability Scores

Select Farmer & Send Offer / Order

Track Order Fulfillment & Payment Status
...
text
Match Score = w1(Crop) + w2(Quantity) + w3(Price) + w4(Quality) + w5(Availability) + w6(Distance) + w7(Market Signals)
...
<p align="center"> <b>🌾 KrishiSetu</b><br> <i>From Farm Supply to Market Demand.</i> </p> ```
